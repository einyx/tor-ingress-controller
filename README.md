...
You can clean up the created CustomResourceDefinition with:
    ...
    kubectl delete crd foos.toringress.k8s.io
...
`tor-ingress` is synced from
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/einyx/tor-ingress-controller.
