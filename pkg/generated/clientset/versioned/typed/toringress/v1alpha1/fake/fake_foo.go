...
var foosResource = schema.GroupVersionResource{Group: "toringress.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "toringress.k8s.io", Version: "v1alpha1", Kind: "Foo"}
